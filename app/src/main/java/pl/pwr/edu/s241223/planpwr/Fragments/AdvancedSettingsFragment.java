...
//        startActivityForResult(myIntent, MY_INTENT_REQUEST_CODE);
        ...
        bFBAuth = view.findViewById(R.id.bFBAuth);

//        bFBAuth.setReadPermissions(Arrays.asList(EMAIL));
        // Callback registration
        bFBAuth.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            @Override
