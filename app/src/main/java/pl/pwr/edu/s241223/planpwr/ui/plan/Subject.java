...
//    private ArrayList<Note> noteArrayList;
     ...
     */
    public Subject(Grid grid, int x, int y, Map<String, Object> map){
//      Init
        settings = new MainWindowSettings(grid);
//        this.noteArrayList = new ArrayList<Note>();
        this.testList = new ArrayList<String>();
        this.width = settings.getSubjectWidth();
        this.height = settings.getSubjectHeight();
...
//      Return Data Of Subject
        return new DataOfSubject(this.posX, this.posY, this.name, this.term, this.time, this.prof,
                ...
                this.absences, this.allAbsences, this.testList);
    }
    ...
    public void drawOutline(Canvas canvas, Paint paint){
        ...
        if (this.week.equals("TN")){
            ...
            canvas.drawRect(this.posX, this.posY, this.width, this.height, paint);
        }
        canvas.restore();
    }
